...
some other ruleset that depends on windows, or in a nested
...
```sh
OVERRIDE="--override_repository=windows=$(pwd)/windows"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@windows` on your system will point to this folder.
...
https://github.com/hermeticbuild/windows_support/actions/workflows/tag.yaml
